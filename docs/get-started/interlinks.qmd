...
[_extension folder](https://github.com/sciris/quartopydoc/tree/main/_extensions/interlinks)
:::
...
:::{.callout-warning}
Be sure to install the latest version of the interlinks filter, using `quarto add sciris/quartopydoc`.
:::
...
:::{.callout-note}
[objects-test.txt](https://github.com/sciris/quartopydoc/tree/main/docs/objects-test.txt) is an example file with one entry: [](`qd2.Auto`).
:::
